...
public interface BookingService {
    ...
    List<Booking> getAllBookingsByUser(Long userId, BookingStatus bookingStatus);

    List<Booking> getAllBookingsForUserItems(Long userId, BookingStatus bookingStatus);
}

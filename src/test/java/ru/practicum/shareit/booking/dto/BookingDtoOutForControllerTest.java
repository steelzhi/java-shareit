...
class BookingDtoOutForControllerTest {
    ...
    @Autowired
    JacksonTester<BookingDtoOutForController> json1;
    ...
    void testBookingDtoOutForController() {
        BookingDtoOutForController bookingDtoOutForController = BookingMapper.mapToBookingDtoOutForController(booking);

        JsonContent<BookingDtoOutForController> result = json1.write(bookingDtoOutForController);

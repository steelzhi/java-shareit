...
class BookingServiceImplTest {
    ...
    void createBooking() {
        ...
        BookingDtoResponseForController createdBooking = bookingService.createBookingDto(bookingDtoIn1, 2L);
    ...
    void patchBookingWithUpdatedStatus() {
        BookingDtoRequest updatedBookingDtoIn1 = BookingDtoRequest.builder()
                .id(booking1.getId())
        ...
        BookingDtoResponseForController updatedBookingDtoOutForController1 =
    ...
    void getAllBookingsByUserStatusWaiting() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.WAITING, null, null),
    ...
    void getAllBookingsByUserStatusCurrent() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.CURRENT, null, null),
    ...
    void getAllBookingsByUserStatusPast() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.PAST, null, null),
                equalTo(new ArrayList<>()));
    ...
    void getAllBookingsByUserStatusRejected() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.REJECTED, null, null),
                equalTo(new ArrayList<>()));
    ...
    void getAllBookingsByUserStatusAll() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.ALL, null, null),
                equalTo(List.of(bookingDtoOutForController2, bookingDtoOutForController1)));
    ...
    void getAllBookingsByUserStatusFuture() {
        ...
        BookingDtoResponseForController bookingDtoOutForController3 =
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.FUTURE, null, null),
    ...
    void getAllBookingsByUserWithPagination() {
        ...
        assertThat(bookingService.getAllBookingDtosByUser(2L, BookingStatus.WAITING, 0, 10),
    ...
    void getAllBookingsForUserItemsWithNotEmptyItems() {
        ...
        assertThat(bookingService.getAllBookingDtosForUserItems(1L, BookingStatus.WAITING, null, null),
    ...
    void getAllBookingsForUserItemsWithEmptyItems() {
        ...
        assertThat(bookingService.getAllBookingDtosForUserItems(2L, BookingStatus.WAITING, null, null),
                equalTo(new ArrayList<>()));
...
/*    @Test
    ...
    void getAllBookingsForUserItemsWithPagination() {
        ...
        assertThat(bookingService.getAllBookingDtosForUserItems(1L, BookingStatus.WAITING, 0, 10),
                equalTo(BookingMapper.mapToBookingDtoOutForController(pagedList.getContent())));

...
@JsonTest
class BookingDtoOutForControllerTest {

    @Autowired
    JacksonTester<BookingDtoResponseForController> json1;
    ...
    @Test
    @SneakyThrows
    void testBookingDtoOutForController() {
        BookingDtoResponseForController bookingDtoOutForController = BookingMapper.mapToBookingDtoOutForController(booking);

        JsonContent<BookingDtoResponseForController> result = json1.write(bookingDtoOutForController);
